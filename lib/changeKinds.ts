 ...
 *   2. monitor        -> releases every DRIFT hold (tamper evidence and an internal error
 *                        are above the posture layer and still stop the call); any
 *                        non-PROCEED drift verdict downgrades
