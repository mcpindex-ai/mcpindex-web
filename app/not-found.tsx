...
export const metadata: Metadata = {
  ...
  // `null`, not a self-canonical: this component renders for EVERY unmatched URL on the
  // domain, so there is no one URL it could name. Without the override it inherits the root
