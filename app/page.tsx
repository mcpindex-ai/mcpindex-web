    ...
    <>
      ...
      <section className="rule-b bg-[var(--color-accent-soft)]">
        <div className="mx-auto max-w-[1180px] px-6 sm:px-10 pt-12 pb-14 sm:pt-16 sm:pb-20">
          <div className="max-w-[820px]">
            ...
            <h2 className="hero-rise hero-rise-2 t-display font-medium text-[var(--color-ink)]">
      ...
      <section className="relative">
        <div className="mx-auto max-w-[1180px] px-6 sm:px-10 pt-20 pb-24 sm:pt-28 sm:pb-32">
          <div className="max-w-[820px]">
            <div className="hero-rise hero-rise-1 font-mono text-[11px] uppercase tracking-[0.22em] text-[var(--color-mute)] mb-8">
            ...
            <p className="hero-rise hero-rise-3 mt-8 text-[17px] sm:text-[19px] leading-[1.45] text-[var(--color-cite)]">
            ...
            <div className="hero-rise hero-rise-3 mt-7 flex flex-wrap items-baseline gap-x-6 gap-y-2 font-mono text-[12.5px] text-[var(--color-mute)]">
              <span>
        ...
        <div className="mx-auto max-w-[1180px] px-6 sm:px-10 py-20 sm:py-24">
          <div className="grid md:grid-cols-2 gap-10 items-end">
            <div>
              ...
              <p className="mt-3 text-[14.5px] leading-[1.55] text-[var(--color-cite)] max-w-[480px]">
...
function PillarRow({
  ...
  return (
    <div className="rule-t first:border-t group grid grid-cols-[60px_1fr] sm:grid-cols-[80px_1fr_minmax(280px,460px)] gap-6 sm:gap-10 py-10 hover:bg-[var(--color-accent-soft)]/30 transition-colors px-2">
      ...
      <div>
        <h3 className="t-h4 font-medium text-[var(--color-ink)]">
          {title}
        </h3>
