...
export type Cta = { label: string; href?: string; contact?: 'enterprise' };
...
// Free tier keeps a plain link into the product; the paid Enterprise tier opens
// the shared in-browser contact modal (replacing the old mailto: links).
